...
let s:p.normal.middle = [ [ s:grey50, s:grey19 ] ]
let s:p.normal.right = [ [ s:grey19, s:grey58 ] ]
let s:p.normal.error = [ [ s:indianred, s:grey19 ] ]
let s:p.normal.warning = [ [ s:khaki, s:grey30 ] ]
let s:p.inactive.left = [ [ s:grey50, s:grey19 ] ]
let s:p.inactive.middle = [ [ s:grey42, s:grey19 ] ]
let s:p.inactive.right = [ [ s:grey19, s:grey42 ] ]
...
let s:p.replace.middle = [ [ s:grey50, s:grey19 ] ]
let s:p.replace.right = [ [ s:grey19, s:grey58 ] ]
